    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Diary>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType("date")
                .HasColumnName("date");
            entity.Property(e => e.AppUserId).IsRequired().HasColumnName("user_id");
        ...
        modelBuilder.Entity<FoodAmount>(entity =>
        {
            ...
            entity.Property(e => e.Alcohol).HasColumnType("numeric(10,4)").HasColumnName("alcohol");
            entity
                .Property(e => e.Amount)
                .IsRequired()
            ...
            entity
                .Property(e => e.AmountName)
                .HasColumnType("varchar")
                .HasColumnName("amount_name");
            entity.Property(e => e.Calcium).HasColumnType("numeric(10,4)").HasColumnName("calcium");
            entity
            ...
            entity.Property(e => e.Fat).HasColumnType("numeric(10,4)").HasColumnName("fat");
            entity.Property(e => e.Fiber).HasColumnType("numeric(10,4)").HasColumnName("fiber");
            entity.Property(e => e.FoodId).HasColumnName("food_id");
            entity.Property(e => e.Iron).HasColumnType("numeric(10,4)").HasColumnName("iron");
            entity
                .Property(e => e.Potassium)
                .HasColumnType("numeric(10,4)")
                .HasColumnName("potassium");
            entity.Property(e => e.Protein).HasColumnType("numeric(10,4)").HasColumnName("protein");
            entity
                .Property(e => e.SaturatedFats)
                .HasColumnType("numeric(10,4)")
                .HasColumnName("saturated_fats");
            entity.Property(e => e.Sodium).HasColumnType("numeric(10,4)").HasColumnName("sodium");
            entity.Property(e => e.Source).HasColumnType("varchar").HasColumnName("source");
            entity.Property(e => e.Sugar).HasColumnType("numeric(10,4)").HasColumnName("sugar");

            entity
                .HasOne(d => d.Food)
                .WithMany(p => p.FoodAmounts)
        ...
        modelBuilder.Entity<FoodMeal>(entity =>
        {
            ...
            entity
                .HasOne(d => d.FoodAmount)
                .WithMany(p => p.FoodMeals)
        ...
        modelBuilder.Entity<Meal>(entity =>
        {
            ...
            entity.Property(e => e.MealId).HasColumnName("meal_id");
            entity.Property(e => e.DiaryId).HasColumnName("diary_id");
            entity.Property(e => e.Name).HasColumnType("varchar").HasColumnName("name");
